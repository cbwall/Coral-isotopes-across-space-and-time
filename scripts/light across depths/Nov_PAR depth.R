...
# Light logger 2: SN 4802, Reef 44, >7m
#####################
...
# Light logger 5: SN 6377, Reef 10, <1m
#####################
...
# Light logger 7: SN 4807, Reef 10, >7m
#####################
...
# Light logger 8: SN 4804, Reef 10, 2m
#####################
...
## combine dataframes
ALL.PAR<-cbind(log1_2484[c(1,3)], log2_4802[c(0,3)], log5_6377[c(0,3)], log7_4807[c(0,3)], log8_4804[c(0,3)], log10_4375[c(0,3)])

colnames(ALL.PAR)<-c("timestamp", "log1_2484_CalPAR","log2_4802_CalPAR", "log5_6377_CalPAR", "log7_4807_CalPAR", "log8_4804_CalPAR","log10_4375_CalPAR")
...
colnames(ALL.PAR)
colnames(ALL.PAR)<-c("timestamp", "Rf44.shallow", "Rf44.deep", "Rf10.shallow", "Rf10.deep", "Rf10.mid", "Rf44.mid")

# reorder columns from N>S and shallow to deep
ALL.PAR<-ALL.PAR[, c(1:2,7,3,4,6,5)]
colnames(ALL.PAR)
