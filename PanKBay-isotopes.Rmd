...
```{r Map fig, results="hide", message="hide", warning="hide", fig.height=5, fig.width=5, fig.align = 'center', fig.cap="**Figure 1a.** *Study site locations in Kāne‘ohe Bay on the windward side of the island of O'ahu, Hawai'i*"}
...
points(sites[,c(3,2)], pch=21, cex=1.2, col="black", bg="salmon")
text(sites[,c(3,2)], labels=c("SE\npatch reef", "SW\nfringe reef", "NE\npatch reef", "NW\nfringe reef"), pos=c(3,3,1,3), cex=0.5)

par(new=T, mar=c(14,14,1,1))
