...
plot(sum.depth.dif~sum.data$Depth..m, col="pink4", pch=21, bg="plum", cex.axis=0.8, cex.lab=0.8,
     ylim=c(-0.3, 0.3), xlim=c(0,10),
     xlab="Field depth observation (m)", ylab="Corrected depth difference (m)")
...
legend("topright", c("clade C", "clade D"), lty=c(1,1), lwd=c(2,2), col=c("salmon", "deepskyblue1"), cex=0.9,
       y.intersp = 1, x.intersp = 0.4, bty="n", inset=c(0.1, 0))
legend("topright", c("", ""), pch=c(21,21), pt.bg=c("salmon", "deepskyblue1"), col=c("red3", "blue"), cex=0.9, y.intersp = 1, x.intersp = 0.4, bty="n", inset=c(0.445, 0))
...
legend("topright", c("clade C", "clade D"), lty=c(1,1), lwd=c(2,2), col=c("palevioletred3", "lightskyblue3"),
       cex=0.9, y.intersp = 1, x.intersp = 0.4, bty="n", inset=c(0.1, 0))
legend("topright", c("", ""), pch=c(21,21), pt.bg=c("palevioletred2", "lightskyblue2"), col=c("palevioletred4", "lightskyblue4"), cex=0.9, y.intersp = 1, x.intersp = 0.4, bty="n", 
       inset=c(0.445, 0))
...
dev.copy(pdf, "figures/isotope/PanKB.CN.scat.pdf", width=7, height=3, encod="MacRoman")
dev.off()
```
...
####### hosts
### shallow summer
plot(host..d15N~host..d13C, data=shallow.sum, col='red3', xlim=c(-20, -12), ylim=c(2.5, 6.5), cex=0.7, pch=21, bg="salmon", main="Summer--host", cex.main=0.7, xaxt="n",
     ylab=(expression(paste(delta^{15}, N, " (\u2030, Air)"))),
     xlab=(expression(paste(delta^{13}, C, " (\u2030, V-PDB)"))), cex.axis=0.8,
     cex.lab=0.8)
Axis(side=1, at = seq(-20, -12, by = 2), cex.axis=0.8)
legend("topright", c(" < 4m", " > 4m"), lty=c(1,1), lwd=c(2,2), col=c("salmon", "deepskyblue1"), cex=0.8,
       y.intersp = 0.9, x.intersp = 0.4, bty="n", inset=c(0.1, 0))
legend("topright", c("", ""), pch=c(21,21), pt.bg=c("salmon", "deepskyblue1"), col=c("red3", "blue"), cex=0.8, y.intersp = 0.9, x.intersp = 0.4, bty="n", inset=c(0.3, 0))
...
### shallow winter
plot(host..d15N~host..d13C, data=shallow.wint, col='red3', xlim=c(-20, -12), ylim=c(2.5, 6.5), cex=0.7, pch=21, bg="salmon", main="Winter--host", cex.main=0.7, xaxt="n", ylab="",
     xlab=(expression(paste(delta^{13}, C, " (\u2030, V-PDB)"))), cex.axis=0.8,
     cex.lab=0.8)
Axis(side=1, at = seq(-20, -12, by = 2), cex.axis=0.8)
legend("topright", c(" < 4m", " > 4m"), lty=c(1,1), lwd=c(2,2), col=c("salmon", "deepskyblue1"), cex=0.8,
...
dev.copy(pdf, "figures/isotope/PanKB.scatdepth.host.pdf", width=6, height=4, encod="MacRoman")
dev.off()
...
### shallow summer
plot(symb..d15N~symb..d13C, data=shallow.sum, col='red3', xlim=c(-20, -12), ylim=c(2.5, 6.5), cex=0.7, pch=21, bg="salmon", main="Summer--Symbionts", cex.main=0.7, xaxt="n",
     ylab=(expression(paste(delta^{15}, N, " (\u2030, Air)"))),
     xlab=(expression(paste(delta^{13}, C, " (\u2030, V-PDB)"))), cex.axis=0.8,
     cex.lab=0.8)
Axis(side=1, at = seq(-20, -12, by = 2), cex.axis=0.8)
...
### shallow winter
plot(symb..d15N~symb..d13C, data=shallow.wint, col='red3', xlim=c(-20, -12), ylim=c(2.5, 6.5), cex=0.7, pch=21, bg="salmon", main="Winter--Symbionts", cex.main=0.7, xaxt="n", ylab="",
     xlab=(expression(paste(delta^{13}, C, " (\u2030, V-PDB)"))), cex.axis=0.8,
     cex.lab=0.8)
Axis(side=1, at = seq(-20, -12, by = 2), cex.axis=0.8)
legend("topright", c(" < 4m", "> 4m"), lty=c(1,1), lwd=c(2,2), col=c("salmon", "deepskyblue1"), cex=0.8,
...
dev.copy(pdf, "figures/isotope/PanKB.scatdepth.symb.pdf", width=6, height=4, encod="MacRoman")
dev.off()
```

```{r C and N isotope scatter host symb, results="hide", eval=FALSE}
# When taking the difference between host and symbiont isotope values for carbon and nitrogen, there is a significant relationship for clade C in the winter (p=0.013)

par(mfrow=c(1,2),mar=c(5,4.5,2,2))

summary(lm(d15N..host.sym~d13C..host.sym, data=C.sum.df)) # not significant p=0.057
summary(lm(d15N..host.sym~d13C..host.sym, data=D.sum.df)) # not significant p=0.096
summary(lm(d15N..host.sym~d13C..host.sym, data=C.win.df)) # SIGNIF p=0.013
summary(lm(d15N..host.sym~d13C..host.sym, data=D.win.df)) # not significant p=0.425

# C summer plot
plot(d15N..host.sym~d13C..host.sym, data=C.sum.df, col='red3', xlim=c(-2.5, 2.5), ylim=c(-0.5, 1.5), cex=0.7, pch=21, bg="salmon", main="Summer", cex.main=0.7,
...
legend("topright", c("clade C", "clade D"), lty=c(1,1), lwd=c(2,2), col=c("salmon", "deepskyblue1"), cex=0.8,
       y.intersp = 0.9, x.intersp = 0.4, bty="n", inset=c(0.1, 0))
legend("topright", c("", ""), pch=c(21,21), pt.bg=c("salmon", "deepskyblue1"), col=c("red3", "blue"), cex=0.8, y.intersp = 0.9, x.intersp = 0.4, bty="n", inset=c(0.355, 0))
ablineclip(lm(d15N..host.sym~d13C..host.sym, data=C.sum.df), col='salmon', x1 = min(C.sum.df$d13C..host.sym), x2 = max(C.sum.df$d13C..host.sym), lwd=2)

# D summer plot
par(new=T)
plot(d15N..host.sym~d13C..host.sym, data=D.sum.df, col='blue', xlim=c(-2.5, 2.5), ylim=c(-0.5, 1.5), cex=0.7, pch=21, bg="deepskyblue1", xaxt="n", yaxt="n", ylab="", xlab ="", cex.main=0.7)
ablineclip(lm(d15N..host.sym~d13C..host.sym, data=D.sum.df), col='deepskyblue1', x1 = min(D.sum.df$d13C..host.sym), x2 = max(D.sum.df$d13C..host.sym), lwd=2)

# C winter plot
plot(d15N..host.sym~d13C..host.sym, data=C.win.df, col='red3', xlim=c(-2.5, 2.5), ylim=c(-0.5, 1.5), cex=0.7, pch=21, bg="salmon", xaxt="n", yaxt="n", main="Winter", ylab="", xlab ="", cex.main=0.7)
ablineclip(lm(d15N..host.sym~d13C..host.sym, data=C.win.df), col='salmon', x1 = min(C.win.df$d13C..host.sym), x2 = max(C.win.df$d13C..host.sym), lwd=2)

# D winter plot
par(new=T)
plot(d15N..host.sym~d13C..host.sym, data=D.win.df, col='blue', xlim=c(-2.5, 2.5), ylim=c(-0.5, 1.5), cex=0.7, pch=21, bg="deepskyblue1", ylab="", cex.main=0.7, yaxt="n",
xlab=(expression(paste(delta^{13}, C[H-S], " (\u2030, V-PDB)"))), cex.axis=0.8,
     cex.lab=0.8)
Axis(side=2, labels=FALSE)
ablineclip(lm(d15N..host.sym~d13C..host.sym, data=D.win.df), col='deepskyblue1', x1 = min(D.win.df$d13C..host.sym), x2 = max(D.win.df$d13C..host.sym), lwd=2)

dev.copy(pdf, "figures/isotope/PanKB.CNdif.scat.pdf", width=6, height=4, encod="MacRoman")
dev.off()
```