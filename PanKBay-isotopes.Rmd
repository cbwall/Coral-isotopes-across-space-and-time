...
```{r random variance, fig.dim=c(3,7), fig.cap="**Figure** *Proportion of model variance explained by the random effect of **Location**, representing the four reef locations where corals were collected within each season*"}
# random effect table
