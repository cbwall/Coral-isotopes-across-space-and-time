...
dev.copy(pdf, "figures/symbionts/Symbionts_by_Season.pdf", encod="MacRoman", height=4, width=5)
dev.off()
...
#### Physiology
```{r physiology figures, results="hide"}
#########################
# Physiology
df.fig<-data.trim
# figure layout
...
- other figures, attempts
```{r other figures, fig.show="hold", eval=FALSE}